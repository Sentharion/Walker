...
import { formatDistance,getDailyStats, formatTime } from '@/utils/stats';
...
const HomeStats = () => {
    ...
    return (
        <View className='items-start justify-center bg-white/15 overflow-hidden px-3 py-4 rounded-xl m-6'>
            ...
            <Text className='text-lg text-white mb-4 pl-2'><Text className='font-semibold text-3xl'>{formatDistance(todayStats.distance,true)}</Text> pokonane</Text>
            <View className='flex-row gap-3 mx-2 flex-wrap'>
                <View className='flex-1 items-start justify-center bg-white/20 overflow-hidden p-3 rounded-lg gap-1'>
                    ...
                    <Text className='text-md font-bold text-white'><Text className='font-bold text-lg'>{formatTime(todayStats.duration,true)}</Text></Text>
                </View>
                <View className='flex-1 items-start justify-center bg-white/20 overflow-hidden p-3 rounded-lg gap-1'>
                ...
                <View className='flex-1 items-start justify-center bg-white/20 overflow-hidden p-3 rounded-lg gap-1'>
                    ...
                    <Text className='text-md font-bold text-white'>{Math.floor(todayStats.calories)} kcal</Text>
                </View>
            </View>
        </View>
    );
