...
import { Footprints, MapPin, Clock, RouteIcon, Flame } from "lucide-react-native";
const details = [
    {
    ...
    {
        icon: <RouteIcon size={24} color="purple"/>,
        Number: "15",
        text: "punktów",
        color: "bg-purple-100",
    },
    {
        icon: <Footprints size={24} color="cyan"/>,
        Number: "15",
        text: "kroków",
        color: "bg-cyan-100",
    },
            ...
            <View className="p-5 gap-4 flex-row">        
                {details.map((detail, index) => (
                    <View key={index} className="flex-1 flex-col flex-grow gap-1 items-center">
                        ...
                        <Text className="text-lg font-semibold">{detail.Number}</Text>
